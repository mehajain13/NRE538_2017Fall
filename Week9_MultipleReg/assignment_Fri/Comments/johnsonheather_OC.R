...
##### Oscar: Your interpretation here is not correct. F-stat is a measurement of RSS reduction when comparing two models.
#####        The p-value is the probability to see one model to explain the same amount of variance as the other one.
#####        In this case, 4.729e-16 is the probability for model2 to explain the same amount of variance as model3 dose.

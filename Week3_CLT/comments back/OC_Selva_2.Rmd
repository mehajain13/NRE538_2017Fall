...
> If you know how to write for loop, it will reduce your work (at least the times you do copy and paste).
> If you can set the x and y limit, it will be more clear to see the shrinkage of histograms. 

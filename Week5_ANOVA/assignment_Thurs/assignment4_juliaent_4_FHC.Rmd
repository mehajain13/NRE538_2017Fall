...
> "a greater effect between nonchilled and chilled Quebec than nonchilled and chilled Mississippi is correct but can not be derived from your current the linear model. That statement is about the interaction term, which is not included in your current linear model. Good try though!

> When you use "#" the font of following text will be enlarged. You can have just plain text without "#" in R markdown. 